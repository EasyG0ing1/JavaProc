...
>This project is a fork and a re-publish from the [JProc](https://github.com/fleipold/jproc) repository. I needed a modular version of the library, so I converted the repository to a Java 11 modular library.
...
```groovy
compile group: 'com.simtechdata', name: 'JavaProc', version: 1.0.0
```
...
```groovy
@Grapes(
  @Grab(group='com.simtechdata', module='JavaProc', version=1.0.0)
)
```

### Basic Use

For the just capturing program output there is a static method:
