...
import static com.simtechdata.process.Helper.asSet;
...
public class ProcBuilder {
    ...
    private Set<Integer> expectedExitStatuses = new HashSet<>() {{
        add(0);
    }};
    ...
    public ProcResult run() throws StartupException, TimeoutException, ExternalProcessFailureException {
        ...
        try {
            ...
            if (!expectedExitStatuses.isEmpty() && !expectedExitStatuses.contains(proc.getExitValue())) {
